---
description: Code review of the current branch. Reads AGENTS.md for project conventions and REVIEW.md for severity calibration, then reviews the diff against master.
---
...
3. Run `git diff master...HEAD` to see what changed. Review every file in the diff, not just a sample.
