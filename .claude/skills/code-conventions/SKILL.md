...
Read [`.agents/skills/code-conventions/SKILL.md`](../../../.agents/skills/code-conventions/SKILL.md) for the rules. That file is the single source of truth, shared with Codex CLI and Gemini CLI.
